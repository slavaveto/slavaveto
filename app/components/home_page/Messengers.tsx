        ...
        <>
            <div className="flex justify-center space-x-5 pt-3 pb-5">
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-2 rounded-full w-11 h-11 sm:w-10 sm:h-10 bg-default-200 text-default-500 sm:hover:bg-success-400 sm:hover:text-white transition flex items-center justify-center
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-2 rounded-full w-11 h-11 sm:w-10 sm:h-10 bg-default-200 text-default-500 sm:hover:bg-danger-300 sm:hover:text-white transition flex items-center justify-center
