            ...
            <div
                ...
                <div>
                    <div className="-pl-10 justify-end justify-center">
                        <p className="font-medium text-[26px] xs375:text-[29px] xs414:text-[30px] xs450:text-[32px] leading-5 pb-1">{t('title')}</p>
                        <p className="leading-4 text-sm italic w-full text-right -text-center pr-[5px]">{t('subtitle')}</p>
                    </div>
                </div>
